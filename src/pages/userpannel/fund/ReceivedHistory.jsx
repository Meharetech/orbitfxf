...
const ReceivedHistory = () => {
    ...
    const fetchHistory = async () => {
        ...
        try {
            ...
            const receivedOnly = res.data.filter(tx => tx.receiverId._id === user._id || tx.receiverId === user.id);
            setHistory(receivedOnly);
        } catch (err) {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 pb-20 animate-in fade-in duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-white/5">
                <div>
                    <h2 className="text-3xl font-black text-white tracking-tight uppercase">Incoming Dispatches</h2>
                    <p className="text-green-500 text-[10px] font-black uppercase tracking-[0.3em] mt-1">Audit trail of received internal assets</p>
                </div>
                <button 
            ...
            {loading ? (
                ...
                <div className="py-24 text-center glass-card border-white/5 bg-white/[0.01]">
                    ...
                    <p className="text-gray-700 text-[10px] font-black uppercase tracking-[0.3em]">No incoming dispatches detected.</p>
                </div>
            ) : (
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="bg-white/[0.02] border-b border-white/5">
                                    ...
                                    <th className="px-6 py-4 text-[9px] font-black text-gray-600 uppercase tracking-widest">Sender Node</th>
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-5 whitespace-nowrap">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-[10px] font-black uppercase tracking-widest text-green-500">Received</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-5">
                                            <div className="flex flex-col">
                                                <span className="text-white text-[11px] font-black uppercase tracking-tight font-mono text-amber-500">
                                        ...
                                        <td className="px-6 py-5 whitespace-nowrap">
                                            <span className="text-sm font-black tracking-tighter text-green-400">
                                                +${tx.amount.toFixed(2)}
                                            </span>
                                        </td>
                                        <td className="px-6 py-5 whitespace-nowrap">
                                        ...
                                        <td className="px-6 py-5 text-right">
                                            <span className="text-[10px] text-gray-500 font-bold italic truncate block max-w-[200px] ml-auto" title={tx.note}>
                                                {tx.note || '—'}
                                            </span>
                                        </td>
                                    </motion.tr>
